...
class PlanoController extends Controller {
    ...
    public function simular() {
        ...
        return response()->json(['planos' => $planos,'total_funcionarios' => $max_funcionarios, 'max_documentos' => (int)$max_documentos, 'max_pro_labores' => (int)$max_pro_labores, 'max_valor' => (float)$max_valor, 'min_valor' => (int)$min_valor,'max_contabeis'=>(int)$max_contabeis]);
    }
