...
<form method="POST" action=""  enctype="multipart/form-data">
    ...
    <div class='form-group'>
        <label>Título</label>
        <input type='text' class='form-control' name='titulo' value="{{Input::old('titulo')}}"/>
    </div>
    <div class='form-group'>
        <label>Texto</label>
        <textarea id='ckeditor' class='form-control' name='texto'>{{Input::old('texto')}}</textarea>
    </div>
    <div class='form-group'>
        <label>Imagem</label>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control date-mask" name='created_at' value='{{Input::old('created_at')}}'/>
    </div>
    <div class='form-group'>
