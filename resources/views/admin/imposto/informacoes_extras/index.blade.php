...
<table class='table'>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$informacao_extra->tipo_formatado()}}</td>
            <td><a class="btn btn-warning" href="{{route('editar-informacao-extra', ['id_imposto' =>$imposto->id,'id_informacao' => $informacao_extra->id])}}">Editar</a> <a class="btn btn-danger" href="{{$informacao_extra->id}}">Remover</a></td>
        </tr>
        @endforeach
        @else
        <tr>
