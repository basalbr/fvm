                ...
                <table class='table table-hover table-bordered table-striped'>
                    ...
                    <tr id="{{$n}}">
                        ...
                        <td class="text-center horario">
                            <input class="form-control time-mask" type="text" placeholder="--:--" name="horario[{{$n}}][0]" value="{{isset(Input::old('horario')[$n][0]) ? Input::old('horario')[$n][0] : $contrato->horarios()->where('dia','=',$n)->first()['hora1']}}">
                        </td>
                        <td class="text-center horario">
                            <input class="form-control time-mask" type="text" placeholder="--:--" name="horario[{{$n}}][1]" value="{{isset(Input::old('horario')[$n][0]) ? Input::old('horario')[$n][0] : $contrato->horarios()->where('dia','=',$n)->first()['hora2']}}">
                        </td>
                        <td class="text-center horario">
                            <input class="form-control time-mask" type="text" placeholder="--:--" name="horario[{{$n}}][2]" value="{{isset(Input::old('horario')[$n][0]) ? Input::old('horario')[$n][0] : $contrato->horarios()->where('dia','=',$n)->first()['hora3']}}">
                        </td>
                        <td class="text-center horario">
                            <input class="form-control time-mask" type="text" placeholder="--:--" name="horario[{{$n}}][3]" value="{{isset(Input::old('horario')[$n][0]) ? Input::old('horario')[$n][0] : $contrato->horarios()->where('dia','=',$n)->first()['hora4']}}">
                        </td>
