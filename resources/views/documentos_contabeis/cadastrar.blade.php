...
@section('main')
    <div class="card">
        ...
        @endif
        <div class='col-xs-12'>
            <p>Selecione o tipo de documento que deseja enviar, selecione o respectivo documento em seu computador
                eclique em anexar.</p>
        </div>
        <form id="anexar-arquivo" method="POST" action="{{route('upload-documento-contabil',[$processo_id])}}"
            ...
            <div class="col-md-12">
                ...
                <div class='form-group'>
                    <button type='button' id="anexar" class='btn btn-primary'><span class='fa fa-plus'></span> Anexar
                    </button>
                </div>
        ...
        <div class="col-xs-12">
            ...
            <form id="enviar-arquivos" method="POST">
                {{ csrf_field() }}
                <div class='form-group'>
                    <button type='submit' class='btn btn-success'><span class='fa fa-send'></span> Enviar Documentos
                        Anexados
                    </button>
