...
<div class='col-xs-12'>
    <div class='card'>
        ...
        <form method="POST" action="" id="principal-form">
            ...
            <div class='form-group'>
                <label>Nome Empresarial Alternativo</label>
            ...
            <h3>Sócios Adicionais</h3>
            <p>Clique em 'Adicionar novo sócio' para cadastrar sócios adicionais<br /></p>
            <div id='socios'></div>
            <div class='form-group'>
                <button id="mostrar-socio" type="button" class='btn btn-primary'>Adicionar novo sócio</button>
            </div>
              <table class='table table-striped'>
                <legend>Lista de Sócios cadastrados</legend>
                <thead>
                    <tr>
                        <th>Nome</th>
                        <th>CPF</th>
            ...
            <hr>
            <div class='form-group'>
                <a href="" id="mostrar-simulador" class='btn btn-primary'>Enviar solicitação</a>
            </div>
        </form>
