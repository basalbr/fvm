...
@section('main')
    ...
    <div class="card">
        ...
        <form method="POST" action="{{route('enviar-informacoes-processo',[$processo->id])}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <br />
            <h3>Informações adicionais</h3>
            <p>{{Auth::user()->nome}}, é necessário enviar algumas informações adicionais para que possamos dar continuidade no processo de apuração.<br />Abaixo estão as informações adicionais de que precisamos.</p>
            ...
            <div class="col-xs-12">
                <div class='form-group'>
                    ...
                    @endif
                    <p>Tipos de arquivo que você pode enviar: {{$informacao_extra->tamanho_maximo}}KBs<br />Extensões válidas: @foreach($informacao_extra->extensoes as $extensao) {!!'<span class="label label-primary">'.$extensao->extensao.'</span>'!!} @endforeach</p>
        ...
        <form method="POST" action="">
            <br />
            <h3>Mensagens</h3>
            <p>Caso esteja com dúvidas com relação a essa apuração, você pode nos enviar uma mensagem pelo formulário abaixo.</p>
            {{ csrf_field() }}
            <div class="col-xs-12">
                <div class='form-group'>
